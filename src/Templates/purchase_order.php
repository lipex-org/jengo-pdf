...
<body>
    ...
    <table class="header-table">
        <tr>
            ...
            <td>
                ...
                <div class="po-meta">Date: <?= esc($poDate ?? date('M d, Y')) ?></div>
                <div class="po-meta">Delivery Date: <?= esc($expectedDate ?? date('M d, Y', strtotime('+14 days'))) ?></div>
            </td>
        </tr>
    </table>
    ...
    <div class="footer">
        Generated by Jengo PDF Engine &bull; Official Procurement Document
    </div>
